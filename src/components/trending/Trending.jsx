...
function Trending() {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        await fetch(`https://api.themoviedb.org/3/trending/movie/week?language=en-US`, options)
        .then(res => res.json())
        .then(data => {
  ...
  return (
    <>
      <section className="trending pt-4" id="trending">
        <h3 className='header fs-1 fw-bold'>Trending Now</h3>
